pipeline {
    ...
    stages {
        ...
        stage('Collect Failed URLs') {
            steps {
                script {
                    def testedUrl = readFile "https://github.com/madhu048/ImginX-Demo.git/tested_url.txt"
